...
const en = {
  ...
  supportBody: "Star the repository and open my X profile to help more developers find COS Workbench.",
  star: "Star on GitHub",
  ...
  setupTitle: "Set up COS Workbench",
  ...
  taskRecordsHint: "Recent 200 turns. Last 64 tool receipts per turn. Prompts, arguments and output stay in native task history.",
  taskRecordsEmpty: "No task records yet. Run a task through COS Workbench to record its tool outcomes.",
  taskRecordsLoading: "Loading task records…",
  taskRunning: "Awaiting completion",
  taskAnswered: "Answer returned",
  taskReview: "Review required",
  taskCopy: "Copy recovery brief",
  taskCopied: "Recovery brief copied",
  taskTools: "Tool calls",
  taskErrors: "Tool errors",
  taskPending: "Dispatched",
  taskReturned: "Returned",
  taskError: "Error",
  taskUnknown: "Unknown outcome",
  taskReturnHint: "A returned result does not prove that the change is correct.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  continue: "继续",
  supportTitle: "开始之前",
  supportBody: "请为仓库 Star，并打开我的 X 主页，帮助更多开发者发现 COS Workbench。",
  ...
  taskRecords: "任务记录",
  taskRecordsHint: "保留最近 200 轮及每轮最近 64 条工具记录。提示、参数和输出保留在原生任务历史中。",
  taskRecordsEmpty: "暂无任务记录。通过 COS Workbench 运行任务以记录工具结果。",
  taskRecordsLoading: "正在加载任务记录…",
  taskRunning: "等待完成",
  taskAnswered: "已返回回答",
  taskReview: "需要检查",
  taskCopy: "复制恢复摘要",
  ...
  taskError: "错误",
  taskUnknown: "结果未知",
  taskReturnHint: "工具返回结果不代表修改已验证正确。",
  activityTitle: "运行时活动",
...
const ja: Record<keyof typeof en, string> = {
  ...
  continue: "続ける",
  supportTitle: "開始する前に",
  supportBody: "より多くの開発者に COS Workbench を知ってもらうため、リポジトリに Star を付け、私の X プロフィールを開いてください。",
  star: "GitHub で Star",
  ...
  setupTitle: "COS Workbench をセットアップ",
  ...
  taskRecords: "タスク記録",
  taskRecordsHint: "直近200ターンと各ターンの直近64件のツール記録を保持します。指示、引数、出力はネイティブのタスク履歴に残ります。",
  taskRecordsEmpty: "タスク記録はまだありません。COS Workbench でタスクを実行すると、ツールの結果を記録します。",
  taskRecordsLoading: "タスク記録を読み込み中…",
  taskRunning: "完了待ち",
  taskAnswered: "回答を受信",
  taskReview: "確認が必要",
  taskCopy: "復旧メモをコピー",
  taskCopied: "復旧メモをコピーしました",
  taskTools: "ツール呼び出し",
  taskErrors: "ツールエラー",
  taskPending: "送信済み",
  taskReturned: "結果を受信",
  taskError: "エラー",
  taskUnknown: "結果不明",
  taskReturnHint: "結果の受信は、変更の正しさを証明しません。",
